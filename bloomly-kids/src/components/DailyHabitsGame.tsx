...
export default function DailyHabitsGame({ onClose, globalStars, setGlobalStars }: DailyHabitsGameProps) {
  ...
  return (
    <div id="daily-habits-container" className="fixed inset-0 z-[9990] bg-gradient-to-br from-indigo-100 to-purple-200 select-none font-sans flex flex-col justify-between overflow-hidden">
