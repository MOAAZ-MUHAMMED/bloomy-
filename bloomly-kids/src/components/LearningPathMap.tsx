...
export const islandsData = [
  ...
  },
  {
    id: "catcher",
    title: "صائد النجوم ⭐",
    character: "🐵 القرد شادي (صائد النجوم)",
    characterEmoji: "🐵",
    emoji: "⭐",
    gameName: "صائد النجوم",
    quest: "مرحباً! أنا القرد شادي. سنصطاد معاً النجوم اللامعة ونتفادى السحب المظلمة لنتعلّم التركيز السريع ونجمع أكبر عدد من النجوم!",
    superpower: "السرعة الفائقة والتركيز الخارق في التقاط النجوم! ⚡",
    badge: "سرعة وتركيز",
    x: 65,
    y: 14
  },
  ...
  {
    id: "spaceCatcher",
    title: "صائد النيازك ☄️",
    character: "🚀 الرائد فضاء (صائد النيازك)",
    characterEmoji: "🚀",
    emoji: "☄️",
    gameName: "صائد النيازك",
    quest: "أهلاً بك يا رائد! سنقوم هنا بصيد النيازك التي تحمل الحرف أو الرقم الصحيح قبل أن تختفي في الفضاء!",
  ...
  },
  {
    ...
    character: "🌱 بلومي المتسابق (بطل السباق)",
    characterEmoji: "🌱",
    emoji: "🏁",
    gameName: "سباق الضغط السريع",
    quest: "أهلاً يا بطل! اضغط بأسرع ما يمكنك لتسبق منافسيك من فريق بلومي في سباق الضغط المثير!",
    superpower: "رد الفعل السريع وسرعة الأصابع! ⚡",
    badge: "رد فعل سريع",
    x: 70,
    y: 61
  },
  {
    id: "quran",
    title: "الدين القيم والقرآن 🕋",
    character: "🦉 الهدهد هدهد (معلم التلاوة والقيم)",
    characterEmoji: "🪶",
    emoji: "🕋",
    gameName: "الدين القيم والقرآن الكريم",
    quest: "أهلاً بك يا صديقي الصغير! سنحفظ قصار السور الكريمة بالتكرار التفاعلي ونستكشف غرفة الأذكار السحرية لنتعلم أذكار اليوم والليلة ونكسب الأجر والنجوم!",
    superpower: "حفظ القرآن الكريم وتلاوة الأذكار اليومية بطلاقة وفصاحة! 🕋✨",
    badge: "تحفيظ وقيم",
    x: 45,
    y: 58
  },
  ...
  {
    id: "kitchenPizzaMaker",
    title: "بيتزا بلومي 🍕",
    character: "👨‍🍳 الشيف بوبو",
    characterEmoji: "🍕",
    emoji: "🍕",
    gameName: "بيتزا بلومي الإيطالية",
    quest: "اضغط على العجينة لإضافة صوص الصلصة والجبن والقطع اللذيذة ثم اخبزها في الفرن!",
  ...
  },
  {
    id: "kitchenJuiceBar",
    title: "عصير بلومي 🍹",
    character: "🍹 الخبير فواكه",
    characterEmoji: "🍹",
    emoji: "🍹",
    gameName: "عصير بلومي المنعش",
    quest: "اختر الفواكه المفضلة وأضف الحليب والثلج في الخلاط السحري لتحضير أحلى عصير!",
    superpower: "إبداع الخلط وصنع العصائر! 🍹",
    badge: "مطبخ ووصفات",
    x: 60,
    y: 79
  },
  ...
  },
  {
    id: "marketShopping",
    title: "لعبة التسوق 🛒",
    character: "🌱 برعم (المساعد الصغير)",
    characterEmoji: "🌱",
    emoji: "🛒",
    gameName: "قائمة التسوق والسوق",
    quest: "يا بطل! ساعدني في تجميع المكونات من قائمة التسوق! اسمع اسم المكون واسحبه لقائمتك، ثم اذهب للسوق واجمع الخضار الطازجة في صندوقك!",
    superpower: "التعرف على الخضار والفواكه والقراءة والسمع! 🥕",
    badge: "عربي + مطبخ",
    x: 60,
    y: 125
  },
  {
    id: "kitchenCooking",
    title: "مطبخ الشيف 🍲",
    character: "🐶 بلومي (الكلب الجائع)",
    characterEmoji: "🐶",
    emoji: "🍲",
    gameName: "الطبخ وإطعام بلومي",
    quest: "رائع! بعد التسوق حان وقت الطبخ! ضع المكونات في الحلة السحرية واطبخ الحساء ثم أطعم الكلب بلومي الجائع!",
    superpower: "الطهي والإبداع في المطبخ وإسعاد الأصدقاء! 👨‍🍳",
    badge: "مطبخ بلومي",
    x: 70,
    y: 130
  },
  {
    ...
    character: "🌻 زهرة عباد الشمس (العالمة)",
    characterEmoji: "🌻",
    emoji: "🌱",
    gameName: "ازرع نبتتك السحرية",
    quest: "هيا نزرع بذرة سحرية! اسحب البذرة للتربة، اسقها بالماء، سلط عليها أشعة الشمس وشاهدها تنمو وتتفتح!",
    superpower: "فهم دورة حياة النباتات وأسرار الطبيعة! 🌿",
    badge: "العلوم والاستكشاف",
    x: 80,
    y: 125
  },
  {
    id: "scienceBodyPuzzle",
    title: "لغز جسم الإنسان 🧬",
    character: "🩺 الدكتور برعم (الطبيب الصغير)",
    characterEmoji: "🩺",
    emoji: "🧬",
    gameName: "ركّب أعضاء الجسم",
    quest: "هيا يا دكتور صغير! اسحب كل عضو وضعه في مكانه الصحيح على جسم الإنسان وتعلم فائدة كل عضو!",
    superpower: "معرفة أعضاء الجسم ووظائفها الرائعة! 🫀",
    badge: "العلوم والاستكشاف",
    x: 90,
    y: 130
  }
