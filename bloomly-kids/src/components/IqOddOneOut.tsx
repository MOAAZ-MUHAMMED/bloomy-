...
export default function IqOddOneOut({ onWin }: IqOddOneOutProps) {
  ...
  return (
    <div className="fixed inset-0 w-full h-full p-6 bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 overflow-y-auto select-none flex flex-col items-center justify-center font-sans">
