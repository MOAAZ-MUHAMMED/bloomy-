...
export const MagicalForestBackground: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-[#bae6fd] via-[#e0f2fe] to-[#bfdbfe]">
      {/* Sunbeams - simplified */}
