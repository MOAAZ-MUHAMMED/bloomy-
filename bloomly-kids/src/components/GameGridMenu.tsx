...
export const GameGridMenu: React.FC<GameGridMenuProps> = ({ 
  ...
  const clayItems = [
    ...
    { id: 'habits', title: 'عادات صحية', englishTitle: 'HABITS', icon: habitsBox?.icon || '🧼', action: () => onSelectGame('habits'), bgGradient: 'linear-gradient(135deg, #e0c3fc, #cfd9df)', color: 'text-slate-800', glow: 'rgba(224,195,252,0.6)' },
