...
export const GameGridMenu: React.FC<GameGridMenuProps> = ({ 
  ...
  const clayItems = [
    ...
    { id: 'stories', title: 'هيا نقرأ', englishTitle: 'LET\'S READ', icon: storiesBox?.icon || '📖', action: () => onSelectGame('stories'), bgGradient: 'linear-gradient(135deg, #e0c3fc, #8ec5fc)', color: 'text-indigo-900', glow: 'rgba(224,195,252,0.6)' },
    ...
    { id: 'quran', title: 'جزيرة القرآن', englishTitle: 'QURAN', icon: '🕋', action: () => onSelectGame('quran'), bgGradient: 'linear-gradient(135deg, #d4fc79, #96e6a1)', color: 'text-green-900', glow: 'rgba(150,230,161,0.6)' },
    ...
    { id: 'fun_games_1', title: 'ألعاب ومرح (1)', englishTitle: 'FUN GAMES 1', icon: '🕹️', action: () => onSelectCategory?.('fun_games_1'), bgGradient: 'linear-gradient(135deg, #a18cd1, #fbc2eb)', color: 'text-purple-900', glow: 'rgba(161,140,209,0.6)' },
    { id: 'fun_games_2', title: 'ألعاب ومرح (2)', englishTitle: 'FUN GAMES 2', icon: '🎈', action: () => onSelectCategory?.('fun_games_2'), bgGradient: 'linear-gradient(135deg, #ff9a9e, #fecfef)', color: 'text-pink-900', glow: 'rgba(255,154,158,0.6)' },
    ...
    { id: 'habits', title: 'عادات صحية', englishTitle: 'HABITS', icon: habitsBox?.icon || '🧼', action: () => onSelectGame('dailyHabits'), bgGradient: 'linear-gradient(135deg, #e0c3fc, #cfd9df)', color: 'text-slate-800', glow: 'rgba(224,195,252,0.6)' },
