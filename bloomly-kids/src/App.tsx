...
export default function App() {
  ...
  const renderGameLogo = (index: number, isActive: boolean) => {
    switch (index) {
      case 0: // Easy Math
        return (
      ...
      default:
        return <span className="text-3xl">{islands[index].emoji}</span>;
    }
  };


  // Magic islands database
  const islands = [
    {
      title: "حديقة الحساب 🍎",
    ...
    },
    {
      ...
      characterEmoji: "🦉",
      emoji: "📚",
      colorClass: "bg-[#EAFDF3] border-[#198754]/40 text-[#198754]",
    ...
    },
    {
      ...
      characterEmoji: "🦊",
      emoji: "🃏",
      colorClass: "bg-[#F3E8FF] border-[#8B5CF6]/40 text-[#8B5CF6]",
    ...
    },
    {
      ...
      characterEmoji: "🐵",
      emoji: "🎈",
      colorClass: "bg-[#FFECF4] border-[#E01E5A]/40 text-[#E01E5A]",
    ...
    },
    {
      ...
      characterEmoji: "🦋",
      emoji: "🎨",
      colorClass: "bg-[#FFEBEB] border-[#EF4444]/40 text-[#EF4444]",
    ...
    },
    {
      ...
      characterEmoji: "🦁",
      emoji: "🔤",
      colorClass: "bg-[#EBF8FF] border-[#2B6CB0]/40 text-[#2B6CB0]",
    ...
    <div className="min-h-screen relative font-sans overflow-x-hidden pb-16 bg-[#FAF7FD]">
      ...
      <section id="what-we-teach" className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <span className="text-4xl animate-bounce-slow inline-block">🗺️</span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#4D2B82] mt-2 mb-4">
            خريطة مغامرات جزر بلومي السحرية! 🧭
          </h2>
          <p className="text-lg text-[#6B4E9E] font-bold">
            اضغط على أي جزيرة في الخريطة لتكشف مهمتك السحرية والقوة الخارقة التي ستحصل عليها!
          </p>
        </div>

        {/* Map and Details Wrapper */}
        {/* Map and Details Unified Box */}
        <div className="w-full overflow-x-auto rounded-[36px] border-4 border-[#4D2B82] shadow-inner mb-8 bg-[#29B6F6] custom-scrollbar" style={{ minHeight: '600px' }}>
          ...
          {/* Sand Shore layer - organic shaped island */}
          ...
          <svg className="absolute inset-0 w-full h-full stroke-dashed stroke-purple-800/40 stroke-[4px] fill-none pointer-events-none z-10" viewBox="0 0 100 100" preserveAspectRatio="none">
            <path d="M 15 18 L 35 12 L 58 15 L 82 15 L 88 42 L 75 65 L 70 85 L 42 82 L 52 55 L 28 48 L 10 42 L 15 75 Z" strokeDasharray="3, 4" />
          </svg>
            ...
            return (
              ...
              >
                <button
                  ...
                  className={`w-14 h-14 sm:w-16 sm:h-16 flex items-center justify-center text-4xl shadow-xl cursor-pointer transition-all duration-300 relative hover:scale-110 active:scale-95 border-4 ${
                    isActive 
                      ? 'border-[#FF7A00] scale-110 shadow-[0_6px_0_0_#FF7A00] bg-yellow-50' 
                      : 'border-[#4D2B82] bg-white hover:border-[#FF7A00]'
                  }`}
                  style={{
                ...
                <div className="absolute top-[110%] left-1/2 -translate-x-1/2 whitespace-nowrap bg-[#4D2B82] text-white text-[9px] sm:text-[11px] font-extrabold px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full border border-white/20 shadow-sm">
                  {island.title}
                </div>
              </div>
            );
                ...
                >
                  ...
                  <div className="flex flex-col items-center text-center mt-4 mb-6">
                    <div className="w-24 h-24 rounded-[32px] bg-gradient-to-br from-purple-100 to-indigo-50 border-3 border-[#4D2B82] flex items-center justify-center text-6xl shadow-md mb-3 transform -rotate-3 hover:rotate-0 transition-transform duration-300 relative">
                      {islands[selectedIslandIndex].characterEmoji}
                    ...
                    <h3 className="text-2xl font-black text-[#4D2B82] mt-2">
                      {islands[selectedIslandIndex].character.split(" ")[1]}
                    </h3>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-purple-50/60 border border-purple-100 rounded-2xl p-3 text-right">
                      ...
                      <span className="text-lg font-black text-[#4D2B82]">
                        {islands[selectedIslandIndex].gameName}
                      </span>
                    </div>

                    {/* Quest Description */}
                    <p className="text-sm font-bold text-[#6B4E9E] leading-relaxed">
                      {islands[selectedIslandIndex].quest}
                    </p>
                    ...
                    <div className="bg-[#FFFDF0] border-2 border-yellow-300 rounded-2xl p-4 text-right shadow-sm">
                      ...
                      <span className="text-sm font-black text-[#D97706] leading-relaxed">
                        {islands[selectedIslandIndex].superpower}
                      </span>
                    </div>
