...
eye_left_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 200" width="150" height="200">
  <ellipse cx="75" cy="100" rx="45" ry="70" fill="#FFFFFF" stroke="#263238" stroke-width="5"/>
</svg>
"""

# 3. eye_right.svg - White right oval eye
eye_right_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 200" width="150" height="200">
  <ellipse cx="75" cy="100" rx="45" ry="70" fill="#FFFFFF" stroke="#263238" stroke-width="5"/>
</svg>
"""

# 4. pupil_left.svg - Black pupil with white reflections
pupil_left_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 150" width="100" height="150">
  <!-- Black Pupil -->
...
pupil_right_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 150" width="100" height="150">
  <!-- Black Pupil -->
  <ellipse cx="50" cy="75" rx="25" ry="40" fill="#212121"/>
  <!-- Highlight Shines -->
  <circle cx="42" cy="55" r="9" fill="#FFFFFF"/>
...
eyebrows_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 100" width="300" height="100">
  <!-- Left Eyebrow Arch -->
...
nose_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" width="80" height="80">
  <defs>
...
mouth_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 120" width="200" height="120">
  <defs>
...
stem_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 200" width="100" height="200">
...
leaf_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 100" width="150" height="100">
  <defs>
...
arm_left_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" width="150" height="150">
...
arm_right_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" width="150" height="150">
...
glove_left_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
  <!-- Glove Palm -->
...
glove_right_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" width="120" height="120">
...
print("SUCCESS: Generated 14 SVG layers inside mascot_apple_v2/ folder!")
